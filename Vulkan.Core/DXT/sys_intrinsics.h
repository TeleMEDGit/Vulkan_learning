...
================================================================================================
*/
inline float __fmuls(float a, float b) { return (a * b); }
inline float __fmadds(float a, float b, float c) { return (a * b + c); }
inline float __fnmsubs(float a, float b, float c) { return (c - a * b); }
inline float __fsels(float a, float b, float c) { return (a >= 0.0f) ? b : c; }
inline float __frcps(float x) { return (1.0f / x); }
inline float __fdivs(float x, float y) { return (x / y); }
inline float __frsqrts(float x) { return (1.0f / sqrtf(x)); }
inline float __frcps16(float x) { return (1.0f / x); }
inline float __fdivs16(float x, float y) { return (x / y); }
inline float __frsqrts16(float x) { return (1.0f / sqrtf(x)); }
inline float __frndz(float x) { return (float)((int)(x)); }
...
inline int CACHE_LINE_CLEAR_OVERFLOW_COUNT(int size) {
