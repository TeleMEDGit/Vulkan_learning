...
#include "sys_intrinsics.h"
	...
	========================
	*/
	inline void idDxtEncoder::CompressImageDXT1Fast(const byte *inBuf, byte *outBuf, int width, int height) {
	...
	========================
	*/
	inline void idDxtEncoder::CompressImageDXT1AlphaFast(const byte *inBuf, byte *outBuf, int width, int height) {
#ifdef ID_WIN_X86_SSE2_INTRIN
	...
	========================
	*/
	inline void idDxtEncoder::CompressImageDXT5Fast(const byte *inBuf, byte *outBuf, int width, int height) {
#ifdef ID_WIN_X86_SSE2_INTRIN
	...
	========================
	*/
	inline void idDxtEncoder::CompressImageDXN1Fast(const byte *inBuf, byte *outBuf, int width, int height) {
	...
	========================
	*/
	inline void idDxtEncoder::CompressYCoCgDXT5Fast(const byte *inBuf, byte *outBuf, int width, int height) {
#ifdef ID_WIN_X86_SSE2_INTRIN
	...
	========================
	*/
	inline void idDxtEncoder::CompressYCoCgCTX1DXT5AFast(const byte *inBuf, byte *outBuf, int width, int height) {
	...
	========================
	*/
	inline void idDxtEncoder::CompressNormalMapDXT5Fast(const byte *inBuf, byte *outBuf, int width, int height) {
#ifdef ID_WIN_X86_SSE2_INTRIN
	...
	========================
	*/
	inline void idDxtEncoder::CompressNormalMapDXN2Fast(const byte *inBuf, byte *outBuf, int width, int height) {
	...
	*/
	...
	========================
	*/
	inline unsigned int idDxtEncoder::AlphaDistance(const byte a1, const byte a2) const {
		return (a1 - a2) * (a1 - a2);
	}
	...
	========================
	*/
	inline unsigned int idDxtEncoder::ColorDistance(const byte *c1, const byte *c2) const {
	...
	========================
	*/
	inline unsigned int idDxtEncoder::ColorDistanceWeighted(const byte *c1, const byte *c2) const {
		int r, g, b;
		int rmean;
	...
	========================
	*/
	inline unsigned int idDxtEncoder::CTX1Distance(const byte *c1, const byte *c2) const {
