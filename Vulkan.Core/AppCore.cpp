...
namespace AppCore
{
	...
	void InitializeApplication(ICoreApp& game)
	{
		Graphics::Initialize();
	...
	void TerminateApplication(ICoreApp& game)
	{
	...
	bool UpdateApplication(ICoreApp& game)
	{
	...
	void RunApplication(ICoreApp& app, const wchar_t* className)
	{
		...
		g_hWnd = CreateWindow((LPCSTR)className, (LPCSTR)className, WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT,
