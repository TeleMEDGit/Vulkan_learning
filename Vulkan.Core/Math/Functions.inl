...
#undef CREATE_SIMD_FUNCTIONS
	...
	INLINE void GlobalPointToLocal(const Matrix4 modelMatrix, const Vector3 &in, Vector3 &out) {

		Vector3 temp = {
			in.GetX() - modelMatrix.GetW().GetX(),
			in.GetX() - modelMatrix.GetW().GetY(),
			in.GetX() - modelMatrix.GetW().GetZ()
		};

		out.SetX(temp.GetX() * modelMatrix.GetX().GetX() + temp.GetY() * modelMatrix.GetX().GetY() + temp.GetZ() * modelMatrix.GetX().GetZ());
		out.SetY(temp.GetX() * modelMatrix.GetY().GetX() + temp.GetY() * modelMatrix.GetY().GetY() + temp.GetZ() * modelMatrix.GetY().GetZ());
		out.SetZ(temp.GetX() * modelMatrix.GetZ().GetX() + temp.GetY() * modelMatrix.GetZ().GetY() + temp.GetZ() * modelMatrix.GetZ().GetZ());
